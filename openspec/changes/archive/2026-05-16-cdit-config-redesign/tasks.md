...
- [x] 9.4 Update the fork's GitHub repo description and topics to mark it as opinionated/fork (not a drop-in replacement). [D4]  _(Done via `gh repo edit`: description names upstream + CDiT differentiators + "not a drop-in replacement; star upstream too"; topics: home-assistant, hacs, adaptive-lighting, circadian-lighting, cdit, opinionated-fork, custom-component, home-automation.)_
